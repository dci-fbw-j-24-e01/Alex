...
public class Words {
    ...
    static {
        Collections.addAll(words, "abruptly", "absurd", "abyss", "affix", "askew", "avenue", "awkward", "axiom",
                ...
                "pshaw", "psyche", "puppy", "puzzling", "quartz", "queue", "quips", "quixotic", "quiz", "quizzes", "quorum",
    ...
    public static String getRandomWord() {
        return words.get((int) (Math.random() * Words.words.size())).toUpperCase();
    }
}
